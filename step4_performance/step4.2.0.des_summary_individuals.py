...
# folder = "HG002.annotated.refine.replaced.filtered"  ## filtered svlen>49
folder = "HG002.annotated.refine.replaced.filteredrange"  ## filtered 49 < svlen < 10001
...
for input in os.listdir(input_dir):
    if input.lower()[:].find(".vcf") != -1:
        ...
        word = input.split('.')
        output = word[0] + "." + word[-3] + "." + word[-2] 
        output_path = output_dir + output
        count_file_path = output_dir + word[0] + "." + word[-3]
        callset = word[-2]
